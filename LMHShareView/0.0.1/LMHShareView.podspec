...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is LMHShareView
                   DESC

  s.homepage     = "https://github.com/Limghi/LMHShareView.git"
  ...
  s.dependency  'YCLToastViewManager'
  
  s.dependency  'YCLiveGlobalConfig'
  ...
  s.source       = { :git => "https://github.com/Limghi/LMHShareView.git", :tag => s.version.to_s }
  ...
  s.source_files  = "LMHShareView/LMHShareView/ShareManager/**/*.{h,m,swift}"
